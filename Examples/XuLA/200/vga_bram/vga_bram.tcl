...
# If you load this file (using the Tcl command: source vga_bram.tcl), then you can
...
set myProject "vga_bram"
set myScript "vga_bram.tcl"
...
proc add_source_files {} {
   ...
   xfile add "../../XuLA_lib/Vga.vhd"
   xfile add "VgaCtlr.vhd"
   xfile add "VgaDisplay.vhd"
   xfile add "ipcore_dir/CharRom.xco"
