# 
# Project automation script for fjmem_intfc 
# 
# Created for ISE version 13.1
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source fjmem_intfc.tcl), then you can
...
set myProject "fjmem_intfc"
set myScript "fjmem_intfc.tcl"
...
proc add_source_files {} {
   ...
   xfile add "fjmem.vhd"
   xfile add "fjmem/fjmem_core.vhd"
   xfile add "fjmem/fjmem_pack-p.vhd"
   xfile add "fjmem_config_pack.vhd"
   xfile add "fjmem_intfc.vhd"
