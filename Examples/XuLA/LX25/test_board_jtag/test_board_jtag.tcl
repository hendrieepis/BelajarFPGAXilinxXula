...
# If you load this file (using the Tcl command: source test_board_jtag.tcl), then you can
...
set myProject "test_board_jtag"
set myScript "test_board_jtag.tcl"
