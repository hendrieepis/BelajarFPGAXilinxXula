...
# If you load this file (using the Tcl command: source ramintfc_jtag.tcl), then you can
...
set myProject "ramintfc_jtag"
set myScript "ramintfc_jtag.tcl"
...
proc add_source_files {} {
   ...
   xfile add "../../XuLA_lib/XuLA2.ucf"
   xfile add "ramintfc_jtag.vhd"
